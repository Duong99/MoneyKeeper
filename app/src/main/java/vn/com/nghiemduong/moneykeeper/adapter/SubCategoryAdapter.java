...
public class SubCategoryAdapter extends RecyclerView.Adapter<SubCategoryAdapter.ViewHolder> {
    ...
    public SubCategoryAdapter(Context mContext, ArrayList<SubCategory> mListSubCategories,
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        SubCategory subCategory = mListSubCategories.get(position);
        if (subCategory != null) {
            holder.ivImageItemSubCategoryPay.setImageBitmap(AppUtils.convertPathFileImageAssetsToBitmap(
                    mListSubCategories.get(position).getSubCategoryPath(), mContext));
            holder.tvTitleItemSubCategoryPay.setText(mListSubCategories.get(position).getSubCategoryName());
        }
    }
