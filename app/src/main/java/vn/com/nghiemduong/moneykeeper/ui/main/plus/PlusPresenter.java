...
public class PlusPresenter implements PlusMvpPresenter{
    ...
    public void addCategories() {
        ...
        listCategories.add(new Category(R.drawable.ic_minus_red,
                mContext.getResources().getString(R.string.spend_money)));
        listCategories.add(new Category(R.drawable.ic_plus_green,
                mContext.getResources().getString(R.string.collect_money)));
        listCategories.add(new Category(R.drawable.ic_cho_vay,
                mContext.getResources().getString(R.string.loan)));
        listCategories.add(new Category(R.drawable.ic_vay,
